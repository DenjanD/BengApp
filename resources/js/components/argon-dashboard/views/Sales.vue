          ...
          <div class="card card-profile shadow">
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="row">
                ...
                <div class="col-2">
                  <button v-on:click="getSpartData" class="btn btn-primary btn-sm ml-n4 mt-5"><i
                      class="fa fa-search"></i></button>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <base-input alternative="" label="Nama Barang" input-classes="form-control-alternative"
                    v-model="spartName" disabled />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <base-input alternative="" label="Harga" input-classes="form-control-alternative" v-model="spartPrice"
                    disabled />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <base-input alternative="" label="Stok" input-classes="form-control-alternative" v-model="spartQty"
                    disabled />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <base-input alternative="" type="number" label="Jumlah" v-model="spartBuyQty"
                    placeholder="Ketik jumlah barang" input-classes="form-control-alternative" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                  <base-button type="primary" size="sm" v-if="tableData.length != 0" v-on:click="saveSale()">Simpan
                    Penjualan</base-button>
                </div>
            ...
            <div class="table-responsive">
              <base-table class="table align-items-center table-flush" tbody-classes="list" :data="tableData">
                ...
                <template slot-scope="{row}">
                  ...
                  <td>
                    <button class="btn btn-danger btn-sm" v-on:click="deleteItem( row.spartCode )"><i
  ...
  export default {
    ...
    methods: {
      getSpartData() {
        ...
        this.axios.post("api/sales/getspart", postData, reqConfig).then(response => {
      ...
      saveSale() {
        ...
        this.axios.post("api/sales", postData, reqConfig).then(response => {
          this.tableData = []
          this.saleTotal = 0
          this.spartCode = ''
          this.spartName = ''
