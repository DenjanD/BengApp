<template>
  <div class="card shadow" :class="type === 'dark' ? 'bg-default': ''">
        ...
        <tr v-for="row in filteredDataShow">
          ...
          <td>
            ...
            <span v-show="editOffset != row.name">
              <base-button type="success" size="sm" @click.prevent="startEditing(row.name,row.technician_id)">
                <i class="fa fa-pen"></i> Ubah
              </base-button>
              <base-button type="danger" size="sm" @click="deleteData(row.technician_id)">
    ...
    <!-- Modal goes here -->
    <modal :show.sync="modals.modal_add_technician">
      <template slot="header">
        <h5 class="modal-title" id="modal_add_technician">Tambah Teknisi Baru</h5>
      </template>
      <div>
        <label>Nama Teknisi Baru</label>
        <form role="form">
      ...
      <template slot="footer">
        <base-button type="secondary" @click="modals.modal_add_technician = false">Batal</base-button>
        <base-button type="primary" @click.prevent="addData()">Simpan Data</base-button>
      </template>
    </modal>

    <modal :show.sync="modals.modal_delete_technician">
      <template slot="header">
        <h5 class="modal-title" id="modal_delete_technician">Hapus Data Teknisi</h5>
      </template>
      <div>
        <label>Anda yakin ingin menghapus data teknisi ini?</label>
      </div>
      <template slot="footer">
        <base-button type="secondary" @click="modals.modal_delete_technician = false">Batal</base-button>
